 ...
 */
export function memoize<T extends (...args: any[]) => any>(func: T, { ttl = 600, cache = CacheService.getScriptCache(), stringifier = JSON.stringify, cacheUndefined = true }: { ttl?: number, cache?: GoogleAppsScript.Cache.Cache, stringifier?: (args: any[]) => string, cacheUndefined?: boolean }): T {
    return ((...args: any[]) => {
